"""
Fit ellipse example from:
    https://scipython.com/blog/direct-linear-least-squares-fitting-of-an-ellipse/

    By Christian Hill, as supplemental material for his book,
...
def get_records(path):
    """Tal Ball function copied from lbrsys as a convenience"""
...
if __name__ == '__main__':
    """  Tal Ball is editing this section for various testing scenarios """
    """
    ...
    x = np.array([n-alpha for n in x])
    y = np.array([n-beta for n in y])
    npts = len(x)
    print(npts)
    ...
    # use the get_ellipse_pts function to draw circle using minor elipse axis
